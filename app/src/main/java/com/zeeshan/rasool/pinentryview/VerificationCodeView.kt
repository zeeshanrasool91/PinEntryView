package com.zeeshan.rasool.pinentryview
...
class VerificationCodeView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0, defStyleRes: Int = 0) :
  ...
  /*val binding = VerificationCodeBinding.inflate(context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater)
    .also { addView(it.root) }*/

  init {
    inflate(context, R.layout.verification_code, this)
